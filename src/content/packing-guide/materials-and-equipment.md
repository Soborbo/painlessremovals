...
description: "A checklist of the packing materials for moving house: box sizes, packing paper, tape and specialist boxes, with quantities for every size of home."
youtubeId: "9F0A50KCOsI"
durationMinutes: 3
order: 2
targetKeyword: "packing materials for moving"
relatedLessons: ["planning-and-preparation", "how-to-pack-kitchen"]
proTip:
  quote: "I see people turn up with boxes from the supermarket, thin as cardboard from a cereal box, and wonder why they're falling apart. Double-walled boxes are the single most important thing you can buy for your move. Everything else — tape, paper, bubble wrap — it all depends on those boxes doing their job."
commonMistakes:
  - title: "Buying single-walled boxes to save money"
    description: "You might save a few pounds upfront, but you'll pay for it in damaged belongings and collapsed stacks. Double-walled boxes are a non-negotiable."
  - title: "Using newspaper instead of packing paper"
    description: "Newspaper ink transfers onto everything — plates, glasses, white fabrics. Packing paper is unprinted and toxin-free, and it's easy to recycle."
  - title: "Not buying enough tape"
    description: "You'll get through more tape than you expect. Buy at least three to four rolls for a standard house move, and keep a spare."
  - title: "Buying five different box sizes"
    description: "More box sizes means more awkward stacking, more wasted space on the van, and more confusion. Two sizes — small/heavy and large/general — cover 95% of household items."
checklist:
  heading: "Materials & Equipment"
  items:
    - "Packing paper — 1 ream per kitchen, 2 reams for a full house pack"
    - "Bubble wrap — at least one 50m roll"
    - "Small double-walled boxes (30×50cm) — for heavy and fragile items"
    - "Large double-walled boxes (40×60cm) — for everything else"
    - "Good quality packing tape — minimum 3–4 rolls"
    - "Fragile tape — 1–2 rolls"
    - "Scissors"
    - "Thick marker pen or labels"
    - "Tape gun (optional but recommended for 80+ boxes)"
    - "Book a home assessment if unsure about quantities"
---
