...
durationMinutes: 11
order: 4
targetKeyword: "how to pack fragile items for moving"
relatedLessons: ["how-to-pack-kitchen", "electronics-and-books"]
proTip:
  quote: "With really precious items, I always say: if you'd be upset to see it broken, give it twice the wrapping you think it needs. An extra minute of bubble wrap is nothing compared to the cost of replacing something irreplaceable. And double fragile tape on the box — it makes sure everyone on the team knows to handle it like it's made of gold."
commonMistakes:
  - title: "Treating all fragile items the same"
    description: "A standard drinking glass and a Royal Doulton vase need very different levels of protection. Match the packing effort to the value and fragility of the item."
  - title: "Not lining the box for high-value items"
    description: "Bubble wrap on the bottom and sides of the box creates a protective shell. Without it, even a well-wrapped item can be damaged if the box is dropped, because the base of the box offers no cushioning on its own."
  - title: "Packing open bottles without taping the caps"
    description: "It only takes one loose cap and one box tipped sideways to create a mess that soaks through multiple boxes. A few seconds with tape is worth it."
  - title: "Stacking things on top of lampshade boxes"
    description: "Lampshades crush under minimal weight. Always label these boxes \"TOP BOX\" and make sure your removal team knows."
  - title: "Forgetting to wrap mirror corners separately"
    description: "The flat surface of a mirror is rarely what breaks — it's the corners taking an impact that causes cracks. Individual corner padding is the single most important step in mirror packing."
checklist:
  heading: "Extra Fragile Items"
  items:
    - "Line boxes with bubble wrap before packing high-value china"
    - "Double-wrap precious items — bubble wrap first, then packing paper"
    - "Pack fewer items per box and fill all gaps with scrunched paper"
    - "Apply two passes of fragile tape on high-value boxes"
    - "Tape the caps of any opened bottles before wrapping"
    - "Label bottle boxes \"THIS WAY UP\" on the top and sides"
    - "Wrap glass-fronted picture frames in bubble wrap, then paper"
    - "Pad mirror corners individually before wrapping the full surface"
    - "Separate lamp shades from lamp bases — pack in different boxes"
    - "Label lampshade boxes \"TOP BOX\" and leave open if possible"
    - "Remove light bulbs and pack or discard separately"
    - "Loop and tape all electrical cables to prevent trailing and snagging"
    - "Inform your removal company about any especially high-value items"
---
