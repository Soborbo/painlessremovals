...
durationMinutes: 2
order: 8
targetKeyword: "how to dismantle furniture for moving"
relatedLessons: ["planning-and-preparation", "bedrooms-and-wardrobes"]
proTip:
  quote: "Bag and tag — that's the golden rule. Every screw, every bolt, every little plastic connector goes into a bag, and that bag gets taped to the furniture. I've seen customers spend hours looking for a single missing bolt on assembly day. Five seconds with a zip-lock bag saves all of that. And if you're not sure how to take something apart, don't force it — call us. We've been dismantling furniture for over 47 years."
commonMistakes:
  - title: "Losing screws and fixings"
    description: "This is the number one dismantling mistake, and it makes reassembly a nightmare. Bag everything and tape it to the furniture — no exceptions."
  - title: "Half-dismantling a wardrobe and leaving it wobbly"
    description: "An unstable piece of furniture is harder to move, more likely to get damaged, and more dangerous to carry. Either dismantle to a stable section or take it all the way apart."
  - title: "Not taking photos before dismantling"
    description: "You'll forget how it went together. A few photos on your phone take seconds and save hours of guesswork later."
  - title: "Trying to force flat-pack furniture apart"
    description: "Chipboard and MDF are unforgiving materials. If a joint is stuck, work it gently. Forcing it will strip the hole or split the board, and that can't be repaired."
  - title: "Forgetting to protect glass surfaces"
    description: "A glass shelf or cabinet door without a cardboard protector is one bump away from shattering. Remove glass components, wrap them individually, and transport them separately."
checklist:
  heading: "Dismantling Furniture"
  items:
    - "Walk through every room and identify items that need dismantling or protection"
    - "Check which items won't fit through doorways or down stairs"
    - "Photograph furniture from multiple angles before dismantling"
    - "Gather tools — Allen keys, screwdrivers, spanners, pliers"
    - "Dismantle beds — remove headboard, side rails, slats, and base"
    - "Bag all screws, bolts, and fixings in zip-lock bags"
    - "Tape each bag of fixings directly to the furniture it belongs to"
    - "Dismantle wardrobes to stable sections — not wobbly half-states"
    - "Remove and individually wrap glass shelves and doors"
    - "Apply cardboard protectors to glass-fronted cabinets"
    - "Remove marble or stone tops and wrap separately"
    - "Wrap antique or high-value furniture in soft blankets with corner protectors"
    - "Remove drawers from desks and tables if they can't be locked shut"
    - "Keep flat-pack assembly instructions or download them from the manufacturer"
    - "If unsure, ask your removal team for advice before moving day"
---
