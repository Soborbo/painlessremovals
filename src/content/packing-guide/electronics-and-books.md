...
durationMinutes: 4
order: 9
targetKeyword: "how to pack electronics and books for moving"
relatedLessons: ["how-to-pack-fragile-items", "key-items"]
proTip:
  quote: "The TV is usually the most expensive single item we move, and the most stressful for customers. My advice: don't rush it. Get a wide roll of bubble wrap, take your time, and make sure those corners are properly padded — especially on the edge-to-edge glass models. And with books — small box, every time. I've seen a fully loaded large box of books go straight through the bottom. It's not pretty."
commonMistakes:
  - title: "Using a large box for books"
    description: "A large box filled with books is dangerously heavy. Stick to the small/heavy box — it exists for exactly this reason."
  - title: "Using narrow bubble wrap for a large TV"
    description: "It takes three times longer, provides worse coverage, and leaves gaps. Buy a wide roll — 100cm or 120cm — for anything bigger than a standard picture frame."
  - title: "Not protecting edge-to-edge glass TVs"
    description: "The exposed glass edges and corners are extremely vulnerable. Foam corner protectors, bubble wrap, and a cardboard front panel are all necessary."
  - title: "Not backing up computers before the move"
    description: "Hard drives can fail from a single hard knock. Back up everything to an external drive or cloud storage before packing."
  - title: "Throwing cables loose into a random box"
    description: "You'll never find the right cable again. Label each cable, coil it neatly, and pack it with the device it belongs to."
  - title: "Overfilling or underfilling book boxes"
    description: "Both cause problems. Overfilled boxes won't stack. Underfilled boxes collapse. Aim for full and flat."
checklist:
  heading: "Electronics and Books"
  items:
    - "Use the original box for TVs and consoles if you still have it"
    - "Wrap TVs in wide bubble wrap (100–120cm rolls)"
    - "Add foam corner protectors for edge-to-edge glass TVs"
    - "Tape a cardboard front panel across the screen for TVs over 60 inches"
    - "Wrap games consoles in bubble wrap and pack in small fragile boxes"
    - "Disconnect, label, and coil all cables"
    - "Put TV remote and streaming device remotes in your essentials box"
    - "Back up desktop and laptop computers before the move"
    - "Pack books in small/heavy boxes (30×50cm) only"
    - "Sort books by size before packing — treat it like a jigsaw puzzle"
    - "Lay special or valuable books flat with paper between them"
    - "Don't overfill — the lid must close flat for safe stacking"
    - "Don't underfill — top up with cushions, clothing, or scrunched paper"
    - "Label all electronics boxes as fragile"
---
...
1. **Wrap the TV in bubble wrap** — one or two full coats around the screen and back. Use wide bubble wrap (120cm rolls are ideal for TVs) rather than narrow rolls. Trying to wrap a 55-inch TV with a 30cm-wide roll is slow, fiddly, and leaves gaps in the coverage.
2. **On the van, the TV goes into a specialist padded TV bag.** Our vans carry these as standard — they accommodate screens up to 60 inches and provide a padded envelope of protection for the journey.
3. **The TV is then wrapped in blankets** on the van for additional cushioning. But we want it properly protected before it leaves the house, because the transition from the living room wall to the van is where most damage happens — navigating doorways, stairs, and tight corners.
...
1. Wrap the console or device in bubble wrap — at least one full layer on all sides.
2. Place it in a small/heavy box (30×50cm).
3. Fill all remaining space with scrunched packing paper so there's absolutely no movement inside the box.
