...
durationMinutes: 5
order: 3
targetKeyword: "how to pack kitchen for moving"
relatedLessons: ["how-to-pack-fragile-items", "how-to-label-and-organise-boxes"]
proTip:
  quote: "When I pick up a kitchen box and give it a shake, I should hear absolutely nothing. No rattling, no sliding, no clinking. That's how I know it's packed right. If there's movement, there's risk — it's that simple."
commonMistakes:
  - title: "Stacking plates flat"
    description: "It feels intuitive, but it's the easiest way to lose an entire set in one accident. Always stack vertically."
  - title: "Using too little paper"
    description: "A single sheet loosely draped over a plate isn't enough. Scrunch it, create bulk, and make sure there's genuine cushioning on every side."
  - title: "Leaving gaps in boxes"
    description: "Even a small void allows movement, and movement causes damage. Fill every space."
  - title: "Packing the kitchen too early"
    description: "You use this room right up until moving day. Pack non-essentials early (baking trays, special occasion crockery, appliances you rarely use), but leave everyday items until the day before the move."
  - title: "Mixing heavy and fragile items carelessly"
    description: "A cast iron pan on top of wrapped wine glasses will end badly, even with paper between them. Keep heavy items at the bottom of the box and fragile items on top, or use separate boxes entirely."
checklist:
  heading: "Kitchen Packing"
  items:
    - "Stock up on packing paper — at least 1 full ream for the kitchen"
    - "Use small/heavy boxes (30×50cm) for all kitchen items"
    - "Wrap every glass and plate individually in scrunched packing paper"
    - "Stack plates vertically, never flat"
    - "Fill all gaps with scrunched paper or soft non-breakable items"
    - "Bundle loose drawer items in paper parcels"
    - "Test each box — pick up and shake gently to check for movement"
    - "Pack every box to the top — no voids, no half-empty boxes"
    - "Label every box \"FRAGILE\" and note the contents"
    - "Leave everyday kitchen essentials until the day before the move"
---
