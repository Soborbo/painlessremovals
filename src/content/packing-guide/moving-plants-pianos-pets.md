...
durationMinutes: 4
order: 10
targetKeyword: "moving plants pianos pets hazardous materials"
relatedLessons: ["planning-and-preparation", "dismantling-furniture"]
proTip:
  quote: "The two things people always forget to plan for are the pets and the gas bottles in the garage. Both need sorting before moving day, not on the day. Get the pets to a friend or a kennel, and check your garage and shed for anything flammable or pressurised — it can't go on the van, and if you only realise that at 8am on moving day, you've got a problem."
commonMistakes:
  - title: "Leaving outdoor plants in the rain until moving day"
    description: "Waterlogged pots are dangerously heavy and leak onto everything around them on the van. Bring them under cover a few days early."
  - title: "Attempting to move a piano without specialist equipment"
    description: "Even an upright piano is heavy enough to cause serious injury if it shifts unexpectedly. Use proper equipment, or hire specialists for grand pianos and difficult access."
  - title: "Leaving pets loose in the house on moving day"
    description: "Open doors, strangers coming and going, and an unfamiliar environment are a recipe for an escaped or distressed pet. Isolate them in one room or arrange for them to be elsewhere."
  - title: "Forgetting about hazardous materials until the van arrives"
    description: "The removal team can't take them, and you'll need to transport them yourself. Sort these items out in advance and have them ready to go in your car."
  - title: "Trying to dig up established garden plants"
    description: "Most won't survive the move. Take cuttings instead and leave the plants for the new owners."
checklist:
  heading: "Plants, Pianos, Pets & Hazardous Materials"
  items:
    - "Group small houseplants in open boxes with paper to prevent movement"
    - "Tie together foliage on medium plants to reduce volume"
    - "Transport large plants as they are — wrap fragile pots in bubble wrap"
    - "Bring outdoor pots under cover 3–4 days before the move to dry out soil"
    - "Take cuttings from established garden plants you want to keep"
    - "Inform your removal company about any pianos during the home assessment"
    - "Close and lock the piano keyboard lid before moving day"
    - "Arrange specialist piano movers for grand pianos or difficult access"
    - "Arrange boarding, a friend, or family for pets on moving day"
    - "If pets stay, isolate them in one quiet room with a sign on the door"
    - "Plan to transport pets in your own car — they cannot travel on the van"
    - "Set up a quiet room with familiar items for pets at the new house"
    - "Identify all hazardous materials (gas, paint, flammables, corrosives)"
    - "Transport hazardous items in your own car or dispose of them before the move"
    - "Check your garage and shed for items that can't go on the van"
---
