...
durationMinutes: 2
order: 5
targetKeyword: "essential items for moving day"
relatedLessons: ["planning-and-preparation", "how-to-label-and-organise-boxes"]
proTip:
  quote: "The essentials box is the one box I tell every customer to sort out before anything else. Not the last thing — the first thing. Decide what goes in it a week before the move, set it aside, and don't let anyone touch it. On moving day, it goes in your car, not on the van. Trust me, you'll want that kettle the moment you walk through the door."
commonMistakes:
  - title: "Not preparing essentials until the morning of the move"
    description: "By then, half of what you need is already packed. Set everything aside at least two days before."
  - title: "Packing medication in regular boxes"
    description: "Keep all medication in your essentials bag, in your car, within reach at all times. This is especially important for prescription medication, inhalers, or anything a family member might need urgently."
  - title: "Forgetting about the first night"
    description: "You'll arrive at the new house tired, hungry, and surrounded by boxes. If you haven't planned what you need for that first evening, it turns into a frustrating search through dozens of identical boxes."
  - title: "Assuming you can \"just pop to the shops\""
    description: "On moving day, you won't have time. The nearest shop might not be where you expect in a new neighbourhood. Pack everything you'll need for the first 48 hours and treat it as self-contained."
checklist:
  heading: "Key Items"
  items:
    - "48 hours of clothing for each family member"
    - "All medication — prescription and everyday (Calpol, painkillers, inhalers)"
    - "Toiletries and a towel per person"
    - "Phone chargers for every household member"
    - "Work and school essentials for the next morning"
    - "Important documents (passports, moving paperwork, insurance)"
    - "Kettle, mugs, tea, coffee, milk, sugar, spoons"
    - "Snacks and basic food for moving day"
    - "Toilet roll, hand soap, basic cleaning supplies"
    - "Box opener or small knife"
    - "TV remote and any streaming device"
    - "Tool kit or labelled bag of furniture fixings"
    - "Label the box \"OPEN FIRST\" on all sides"
    - "Transport essentials in your own car, not the van"
---
