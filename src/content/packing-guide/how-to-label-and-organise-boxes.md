...
durationMinutes: 2
order: 6
targetKeyword: "how to label moving boxes"
relatedLessons: ["planning-and-preparation", "how-to-pack-kitchen"]
proTip:
  quote: "Room first, contents second — always in that order. When you're carrying 80 boxes into a house, the room is what matters most. I don't need to know it's crockery until I'm in the kitchen — I just need to know it's going to the kitchen. And write it on the tape. It keeps things neat, and your boxes live to fight another move."
commonMistakes:
  - title: "Not labelling at all"
    description: "It's tempting to think you'll remember what's in each box. You won't. After packing 60 or 70 boxes over several weeks, they all blur together. Label every single one."
  - title: "Only labelling the top"
    description: "Boxes are often stacked three or four high. If the label is only on the top, you can't read it without unstacking. Write or place a sticker on at least one side as well."
  - title: "Writing the origin room instead of the destination room"
    description: "\"Spare bedroom\" might mean something in your current house, but if there's no spare bedroom at the new place, it tells the removal team nothing. Always label with where the box should go, not where it came from."
  - title: "Using tiny handwriting"
    description: "Labels need to be read quickly from a few feet away, often in a dimly lit hallway while carrying something heavy. Write in large, clear block capitals with a thick marker. If it can't be read at arm's length, it's too small."
checklist:
  heading: "Box Labelling"
  items:
    - "Write the destination room (not the origin room) on every box"
    - "Add a brief contents description below the room name"
    - "Write on the tape, not directly on the cardboard"
    - "Use large, clear block capitals with a thick marker"
    - "Label the top and at least one side of every box"
    - "Apply fragile tape to all boxes containing breakable items"
    - "Mark \"THIS WAY UP\" on boxes with bottles or liquids"
    - "Mark your essentials box \"OPEN FIRST\" on all sides"
    - "Mark delicate boxes \"TOP BOX\" so nothing is stacked on them"
    - "Consider a colour-coding system for large moves (coloured tape or dot stickers)"
    - "Place matching colour swatches on door frames at the new house"
---
