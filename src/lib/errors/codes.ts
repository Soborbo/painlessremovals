...
// ============================================================
// 2. SRV — Server / CF Pages Function Hibák (23 kód)
// ============================================================

export const SRV_CODES: Record<string, ErrorCodeDef> = {
  'SRV-FUNC-001':    { severity: 'CRITICAL', retryable: false, userImpact: 'blocked',  message: 'Pages Function unhandled exception', requiredContext: ['functionPath', 'errorMessage'] },
  'SRV-FUNC-002':    { severity: 'CRITICAL', retryable: false, userImpact: 'blocked',  message: 'Pages Function timeout (>30s)', requiredContext: ['functionPath', 'durationMs', 'lastStep'] },
  'SRV-FUNC-003':    { severity: 'ERROR',    retryable: false, userImpact: 'blocked',  message: 'Pages Function memory limit', requiredContext: ['functionPath'] },
  'SRV-FUNC-004':    { severity: 'WARN',     retryable: false, userImpact: 'degraded', message: 'Pages Function cold start >2s', requiredContext: ['functionPath', 'coldStartMs'] },
  'SRV-FUNC-005':    { severity: 'ERROR',    retryable: false, userImpact: 'blocked',  message: 'Pages Function CPU limit', requiredContext: ['functionPath', 'cpuMs'] },
...
export const BUILD_CODES: Record<string, ErrorCodeDef> = {
  ...
  'BUILD-DEPLOY-001':  { severity: 'CRITICAL', retryable: true,  userImpact: 'blocked', message: 'CF Pages deploy failed', requiredContext: ['deployId'] },
  'BUILD-DEPLOY-002':  { severity: 'WARN',     retryable: true,  userImpact: 'none',    message: 'CF Pages deploy timeout', requiredContext: ['durationMs'] },
...
export const PROJECT_CODES: Record<string, ErrorCodeDef> = {
  // Painless Removals — Address / Google Maps
  'MOVE-ADDR-001':  { severity: 'ERROR',    retryable: true,  userImpact: 'degraded', message: 'Google Maps autocomplete failed', requiredContext: ['errorMessage'] },
  'MOVE-ADDR-002':  { severity: 'WARN',     retryable: false, userImpact: 'degraded', message: 'Address selection parse error', requiredContext: ['rawAddress'] },
  'MOVE-ADDR-003':  { severity: 'ERROR',    retryable: true,  userImpact: 'blocked',  message: 'Route/distance calculation failed', requiredContext: ['from', 'to'] },
  // Painless Removals — Quote save / email
  'MOVE-QUOTE-001': { severity: 'CRITICAL', retryable: false, userImpact: 'blocked',  message: 'Quote save failed — lead may be lost', requiredContext: ['errorMessage'] },
  'MOVE-QUOTE-002': { severity: 'ERROR',    retryable: true,  userImpact: 'degraded', message: 'Customer email send failed', requiredContext: ['errorMessage'] },
  'MOVE-QUOTE-003': { severity: 'ERROR',    retryable: true,  userImpact: 'none',     message: 'Admin notification email failed', requiredContext: ['errorMessage'] },
  // Painless Removals — i-mve CRM
  'MOVE-IMVE-001':  { severity: 'ERROR',    retryable: true,  userImpact: 'none',     message: 'i-mve CRM sync failed', requiredContext: ['errorMessage'] },
  'MOVE-IMVE-002':  { severity: 'WARN',     retryable: true,  userImpact: 'none',     message: 'i-mve CRM sync timeout', requiredContext: ['durationMs'] },
  // Painless Removals — Callback
  ...
  'MOVE-UI-001':    { severity: 'ERROR',    retryable: false, userImpact: 'blocked',  message: 'React component render error', requiredContext: ['componentName'] },
};
